{{-- resources/views/reports/stock_valuation.blade.php --}}
@extends('layouts.app')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Filter Laporan Valuasi Stok</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('reports.generate-stock-valuation') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="min_value" class="form-label">Nilai Minimum (Rp)</label>
                            <input type="number" class="form-control" id="min_value" name="min_value" min="0"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="group_by" class="form-label">Kelompokkan Berdasarkan <span
